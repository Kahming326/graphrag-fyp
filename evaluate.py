...
eval_questions = [
    "What are the key differences between the attention mechanisms in the original Transformer (Attention Is All You Need) and BERT, and how do these differences impact their performance on language tasks?",
    "How do Transformer address the limitations of traditional RNNs in handling long-range dependencies, and what novel mechanisms do they introduce to improve sequence modeling?",
    "How did the Transformer architecture improve over RNNs, and how does BERT refine the attention mechanism to improve NLP tasks?",
    "What are the limitations of multi-head attention in Transformer, and how does Transformer-XL address these limitations?",
